...
/**
 * Internal specification that composes two specifications using logical AND.
 */
...
final class AndSpecification<T> extends AbstractSpecification<T> {
    ...
    /**
     * Creates an AND-composed specification.
     *
    ...
    /**
     * Evaluates the candidate using logical AND semantics.
     *
     * @param candidate the value to evaluate
     * @return {@code true} when both specifications are satisfied
     */
