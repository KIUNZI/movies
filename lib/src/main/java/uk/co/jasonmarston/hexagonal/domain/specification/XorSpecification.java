...
/**
 * Internal specification that composes two specifications using logical XOR.
 */
...
final class XorSpecification<T> extends AbstractSpecification<T> {
    ...
    /**
     * Creates an XOR-composed specification.
     *
    ...
    /**
     * Evaluates the candidate using logical XOR semantics.
     *
     * @param candidate the value to evaluate
     * @return {@code true} when exactly one specification is satisfied
     */
