plugins {
    ...
    id("uk.co.jasonmarston.project.standards.java-library") version "1.0.0" apply false
    id("uk.co.jasonmarston.project.standards.quarkus-library") version "1.0.0" apply false
    id("uk.co.jasonmarston.project.standards.quarkus-app") version "1.0.0" apply false
    id("uk.co.jasonmarston.project.standards.liquibase") version "1.0.0" apply false
    id("uk.co.jasonmarston.project.standards.version") version "1.0.0"
    id("uk.co.jasonmarston.project.standards.gitops") version "1.0.0"
}
